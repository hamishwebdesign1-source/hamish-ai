...
// Moved here from (site)/page.tsx 2 Sep 2026 — the Agency Platform
// (formerly /platform, now the homepage) is the growth focus going
// forward; this Edinburgh-client-services pitch is "archived" off the
// homepage but deliberately not deleted or redirected away — the
// consultancy work is still real and ongoing, just no longer where new
// effort is going (per direct instruction, not an assumption), and
// /platform's own pitch depends on this work being citable as genuine
// proof ("Built and running internally first"). Moved verbatim, not
// rewritten — same content, same real claims, new address. Own metadata
// now required (previously inherited the root layout's default, which
// described exactly this page — now the root default describes the
// Platform instead, so this page needs its own copy of what was there).
