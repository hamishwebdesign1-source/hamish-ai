...
// the real prospects row (concept_slug = "deli-express").
// description added same pass — see blackadder-mcmonagle/layout.tsx.
export const metadata: Metadata = {
  title: "Deli Express",
  description:
    "A concept website redesign by HamishAI for Deli Express — a real example of what AI-powered redesign could look like.",
};
