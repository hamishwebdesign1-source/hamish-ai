...
// the real prospects row (concept_slug = "c4-joinery").
// description added same pass — see blackadder-mcmonagle/layout.tsx.
export const metadata: Metadata = {
  title: "C4 Joinery Ltd",
  description:
    "A concept website redesign by HamishAI for C4 Joinery Ltd — a real example of what AI-powered redesign could look like.",
};
