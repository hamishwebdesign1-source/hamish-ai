...
// the real prospects row (concept_slug = "capture-boutique").
// description added same pass — see blackadder-mcmonagle/layout.tsx.
export const metadata: Metadata = {
  title: "Capture Boutique",
  description:
    "A concept website redesign by HamishAI for Capture Boutique — a real example of what AI-powered redesign could look like.",
};
