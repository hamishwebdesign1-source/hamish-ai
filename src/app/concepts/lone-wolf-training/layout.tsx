...
export const metadata: Metadata = {
  title: "Lone Wolf High Performance Training",
  description:
    "A concept website redesign by HamishAI for Lone Wolf High Performance Training — a real example of what AI-powered redesign could look like.",
};
