  ...
  return (
    <div className="min-h-screen bg-[#faf6ef] text-[#2b241c]">
      ...
      <section id="book" className="border-t border-[#e4dac7] px-6 py-16 text-center">
        ...
        <div className="mx-auto mt-6 max-w-xs rounded-sm border border-[#e4dac7] bg-white p-4 text-left">
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="rounded-sm border border-[#e4dac7] px-3 py-2 text-[#6b5f4d]">
              Fri 24 Jul
            </div>
            <div className="rounded-sm border border-[#e4dac7] px-3 py-2 text-[#6b5f4d]">
              2 nights
          ...
          <div className="mt-3 flex items-center gap-2 rounded-sm bg-[#5c1f2b]/5 px-3 py-2 text-xs text-[#5c1f2b]">
            <span>✓</span>
            <span>18% less than booking through an OTA for this stay.</span>
          </div>
          <button
            type="button"
            className="mt-3 w-full rounded-sm bg-[#2b241c] px-6 py-2.5 text-sm font-medium text-[#faf6ef] hover:bg-[#3a3227]"
          >
            Book direct
          </button>
        </div>
