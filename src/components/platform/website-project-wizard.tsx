...
import { WEBSITE_OBJECTIVES, SITEMAP_PAGE_OPTIONS, type WebsiteDiscovery } from "@/lib/website-brief";
...
export function WebsiteProjectWizard({ clients }: { clients: { id: string; business_name: string }[] }) {
