...
// follow-up) email for this lead, then opens it in Gmail compose (never
// an auto-send — the operator always reviews and hits send). The tab is
// opened synchronously inside the click handler (not the effect that
// fires once the async draft comes back) so browsers don't treat it as
